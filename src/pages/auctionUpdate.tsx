...
const UpdateAuctionForm: React.FC = () => {
  ...
  const [auction, setAuction] = useState<any>(auctionFromState || null);
  const [adminData, setAdminData] = useState(null);
  ...
  // If auction data not passed from state, fetch it
  useEffect(() => {
    ...
    <div>
      ...
      <div className="max-w-4xl mx-auto p-6 mt-6">
        <div className="bg-white p-6 rounded-lg shadow-lg">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label htmlFor="name" className="block text-sm font-medium text-gray-700">Auction Name</label>
              <input
                type="text"
                id="name"
                name="name"
