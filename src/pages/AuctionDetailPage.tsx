...
//         `https://metaauction.onrender.com/bids/getBids/${userId}/${auctionId}`
//       );
//       setAuctions(prev => prev ? { ...prev, bids: res.data } : prev);
//     } catch (err) {
...
//               <span className="text-blue-800 font-semibold">₹{item.bidAmount}</span>
//             </div>
...
//               <span>{new Date(item.bidTime).toLocaleString()}</span>
//             </div>
//           </div>
//         </div>
//       ))}
