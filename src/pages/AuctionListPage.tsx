...
const AuctionListPage: React.FC = () => {
  ...
  const applySorting = (auctions: Auction[], option: SortOption) => {
    ...
    switch (option) {
      ...
      case 'price-desc':
        return sorted.sort((a, b) => b.startingPrice - b.startingPrice);
      case 'date-asc':
    ...
    <Layout>
      <div className="container mx-auto px-4 py-8 bg-gray-50">
        ...
        <motion.div
          ...
          className="mb-8 flex items-center text-teal-500 hover:text-teal-700"
        >
        ...
        {/* Auction Grid */}
        {isLoading ? (
          <div className="flex justify-center items-center py-20 bg-gray-50 animate__animated animate__pulse">
          ...
          >
            {filteredAuctions.map((auction, index) => (
              <motion.div
                ...
                } hover:shadow-lg transition animate__animated animate__fadeInUp`}
